...
<img src="fig/fig4/fig11.png" style="zoom:80%" />
...
- $
  ...
  ​    &= H(z) - \mathbb{E}_{(z,x) \sim p(z,x)}[- \log p(z|x)] \\

  ​    &= H(z) + \mathbb{E}_{(z,x) \sim p(z,x)}[\log p(z|x) - \log q(z|x) + \log q(z|x)] \\

  ​    &\geq H(z) + \mathbb{E}_{(z,x) \sim p(z,x)}[\log q(z|x)]
